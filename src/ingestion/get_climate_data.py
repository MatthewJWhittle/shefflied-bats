...
def construct_transform(bounds:tuple, resolution:float):
...
def reproject_data(array, crs, transform, resolution):
    """
...
def main(
    ...
    model_transform = construct_transform(boundary.total_bounds, spatial_config["resolution"])
